...
const { checkEmail, getAllProduct, getAllSections, getAllBrands, createProduct, updateProduct, deleteProduct, getAllCategories } = require('../controllers/apiController');
